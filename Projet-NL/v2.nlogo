...
to pickup-box
    ask humans [
        if (count-boxes >= 1) [ 
            ...
            ifelse get-weight b + carrying < capacity [
                carry self b
            ] [
                set help-needed? true
                set color red
            ]
        ]
    ]
...
to-report get-target [hmn]
  report [target] of hmn
end
